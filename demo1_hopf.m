...
branch2.parameter.min_bound(1,:)=[ind_theta_u 0];
branch2.parameter.max_bound(1:2,:)=[[ind_theta_u 4]' [ind_taus 10]']';
branch2.parameter.max_step(1:2,:)=[[ind_theta_u 0.2]' [ind_taus 0.5]']';
branch2.point=hopf;
