...
figure(6); clf;
[branch2,s,f,r]=br_contn(funcs,branch2,50);            % continue with plotting hopf branch:
...
%% Continue Hopf bifurcation after turning point
...
branch3.point=branch2.point(end);
